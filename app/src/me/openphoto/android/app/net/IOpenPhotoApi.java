...
public interface IOpenPhotoApi {
	 ...
	 * 
	 * @param name
	 *            Name of the app for which authorization is requested
	 * @param callback
	 *            Where the user should be forwarded after authorizing the app.
	 ...
	 *            the image file
	 * @param metaData
	 *            MetaData which define title, ... of the photo
	 * @param progressListener
	 *            Listener that will be called on progress
