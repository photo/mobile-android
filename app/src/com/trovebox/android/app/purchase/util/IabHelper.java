...
/**
    ...
    public boolean handleActivityResult(int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
            ...
            result = new IabResult(IABHELPER_USER_CANCELLED, R.string.errorIabUserCanceled);
            if (mPurchaseListener != null)
                mPurchaseListener.onIabPurchaseFinished(result, null);
        }
        else {
    ...
    public void queryInventoryAsync(final boolean querySkuDetails,
        ...
        new QueryInventoryTask(querySkuDetails, moreSkus, listener, loadingControl).execute();
    }
    ...
    private class QueryInventoryTask extends SimpleAsyncTaskEx
    {
        IabResult result;
        Inventory inv;
        ...
        public QueryInventoryTask(boolean querySkuDetails,
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                GuiUtils.error(TAG, R.string.errorCouldNotQueryInventory, e);
            }
            return false;
        }
    ...
    public void queryInventoryAsync(QueryInventoryFinishedListener listener,
            LoadingControl loadingControl) {
        queryInventoryAsync(true, null, listener, loadingControl);
    }
    public void queryInventoryAsync(QueryInventoryFinishedListener listener) {
    ...
    public void setPurchaseListener(OnIabPurchaseFinishedListener purchaseListener) {
        this.mPurchaseListener = purchaseListener;
    }

    public void setPurchasingItemType(String purchasingItemType) {
        this.mPurchasingItemType = purchasingItemType;
    }
}
